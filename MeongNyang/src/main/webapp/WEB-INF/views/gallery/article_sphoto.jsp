	    ...
	    <div class="body-main mx-auto">
							...
							<div class="img-box">
								<c:forEach var="vo" items="${listFile}">
									<img src="${pageContext.request.contextPath}/uploads/gallery/${vo.imageFilename}"
										onclick="imageViewer('${pageContext.request.contextPath}/uploads/gallery/${vo.imageFilename}');">
								</c:forEach>
							</div>
						</td>	
					</tr>
					...
					<tr>
						<td colspan="2">
							...
							<c:if test="${not empty preReadDto}">
								<a href="${pageContext.request.contextPath}/gallery/article.do?num=${preReadDto.num}&page=${page}">${preReadDto.subject}</a>
							</c:if>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							...
							<c:if test="${not empty nextReadDto}">
								<a href="${pageContext.request.contextPath}/gallery/article.do?num=${nextReadDto.num}&page=${page}">${nextReadDto.subject}</a>
							</c:if>
						</td>
					</tr>
				</tbody>
			...
			<table class="table">
				<tr>
					...
					<td align="right">
						<button type="button" class="btn" onclick="location.href='${pageContext.request.contextPath}/gallery/list.do?page=${page}';">리스트</button>
					</td>
				</tr>
			</table>
	    </div>
